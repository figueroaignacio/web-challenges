    ...
    <>
      ...
      <section className="grid text-center lg:text-start place-items-center lg:grid-cols-2 min-h-[80dvh] gap-y-12">
        <div className="space-y-3">
          ...
          <div className="lg:backdrop-blur-3xl lg:p-5 lg:rounded-xl">
            <p>
        ...
        <Link
          to="/destination"
          className="bg-white text-black size-72 flex justify-center items-center rounded-full hover:scale-110 transition-transform duration-100 hover:brightness-200 hover:shadow-2xl font-bellefair text-2xl tracking-widest"
        >
          EXPLORE
        </Link>
      </section>
