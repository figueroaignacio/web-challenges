export function HeroImageDesktop() {
  return (
    <svg
      ...
      className="hidden lg:block absolute top-0 left-0 -z-50"
    >
      <defs>
      ...
      <g transform="translate(0 -20)" fill="none" fill-rule="evenodd">
        <rect
          fill="url(#a)"
          transform="rotate(45 974.87 593.87)"
          x="955.87"
          y="574.87"
          width="38"
          height="38"
        ...
        <rect
          fill="url(#b)"
          transform="rotate(45 516.02 369.542)"
          x="507.521"
          y="361.042"
          width="17"
          height="17"
        ...
        <path
          ...
          stroke-width="10"
          opacity=".543"
          transform="rotate(30 1330.173 303.173)"
        />
        <path
          ...
          stroke-width="10"
          opacity=".543"
          transform="rotate(30 840.2 190.2)"
        />
        <path
