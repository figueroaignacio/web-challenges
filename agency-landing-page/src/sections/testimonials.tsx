export function Testimonials() {
  ...
  return (
    <section className="min-h-dvh flex flex-col justify-center items-center px-2 bg-[#ffd300]">
      ...
      <ul className="space-y-6 lg:space-y-0 lg:flex justify-center items-center h-auto gap-2 max-w-7xl mx-auto ">
        {testimonials.map((item) => (
          <li className="flex flex-col text-center items-center gap-y-12 p-14 shadow-md h-auto rounded-xl border border-black/20 bg-white">
            <img
              src={item.avatar}
              alt={item.name}
